...
export default interface EarnEventClaimRepositoryInterface {
    create: (earnEventId: string, userId: string, status: EarnEventClaimStatus, thirdPartyUserId?: string) => Promise<EarnEventClaim>;
    ...
    findOnlyActiveByEarnEventIdAndUserId: (earnEventId: string, userId: string) => Promise<EarnEventClaim[]>;
